self.addEventListener('push', function(event) {  
  ...
  self.addEventListener('push', function(event) {
    ...
    event.waitUntil(
      self.registration.pushManager.getSubscription().then(function(subscription) {
        var notificationsPath = 'https://notification.carryai.co/notifications?endpoint=' + encodeURIComponent(subscription.endpoint);
  ...
  self.addEventListener('notificationclick', function(event) {
    ...
    var targetUrl = 'https://notification.carryai.co/notifications/' + event.notification.tag + '/redirect';
    if (event.action) {
  ...
  self.addEventListener('pushsubscriptionchange', function(event) {
    event.waitUntil(
      fetch('https://notification.carryai.co/pushsubscriptionchange', {
        method: 'POST',
